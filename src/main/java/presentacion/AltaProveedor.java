...
public class AltaProveedor extends JPanel {
    ...
    private final JTextField txtNombre, txtCorreo, txtRFC, txtTelefono, txtCalle,
            ...
            txtCiudad, txtPais;
    private JComboBox comboEstatus;
    ...
    public AltaProveedor() {
        ...
        JLabel lblTitulo = new JLabel("Alta Proveedor", JLabel.CENTER);
        ...
        String[] Estatus = { "ACTIVO", "INACTIVO" };
        comboEstatus = new JComboBox<>(Estatus);
        comboEstatus.setFont(new Font("Arial", Font.PLAIN, 14));
        comboEstatus.setBackground(Color.decode("#A4C5E1"));
        comboEstatus.setBorder(new LineBorder(Color.GRAY));

        JTextField[] campos = { txtNombre, txtCorreo, txtRFC, txtTelefono, txtCalle,
                txtColonia, txtNoExt, txtNoInt, txtCP, txtMunicipio, txtEstado, txtCiudad, txtPais };
        ...
        // Fila 3
        addCampo(panelCentral, gbc, y++, "Estado", txtEstado, "Ciudad", txtCiudad);
        // Fila 4
        ...
        // Fila 6
        addCampoComboBox(panelCentral, gbc, y++, "Municipio", txtMunicipio, "Estatus", comboEstatus);
        // Fila 7
        addCampo(panelCentral, gbc, y++, "País", txtPais, "", null);
        ...
        btnGuardar.addActionListener(e -> {
            logic.procesarGuardarProveedor(
                    txtNombre, txtRFC, txtCorreo, txtTelefono,
                    txtEstado, txtCiudad, txtCalle, txtColonia,
                    txtNoExt, txtNoInt, txtCP, txtMunicipio,
                    txtPais, comboEstatus
            );
        });
        ...
        btnCancelar.addActionListener(e -> {
            Window window = SwingUtilities.getWindowAncestor(AltaProveedor.this);
            if (window != null) {
                window.dispose();
            }
        });
    ...
    private void addCampoComboBox(JPanel panel, GridBagConstraints gbc, int fila,
            String etiqueta1, JTextField campo1,
            String etiqueta2, JComboBox campo2) {
        gbc.gridy = fila;
